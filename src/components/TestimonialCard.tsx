    ...
    >
      <Card className="overflow-hidden bg-white/50 dark:bg-white/1 backdrop-blur-3xl border border-white dark:border-white/5 rounded-[56px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.05)] dark:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] hover:shadow-[0_48px_80px_-24px_rgba(0,0,0,0.1)] transition-all duration-700">
        ...
        <CardContent className="pt-12 pb-10 px-8 lg:pt-20 lg:pb-16 lg:px-20 relative z-10">
          ...
          <p className="text-2xl lg:text-6xl font-serif italic text-slate-900 dark:text-white leading-tight lg:leading-[1.1] tracking-tight text-pretty">
            &quot;{testimonial.content}&quot;
          </p>
        </CardContent>

        <CardFooter className="flex justify-between items-center py-6 px-8 lg:py-10 lg:px-20 border-t border-white dark:border-white/5 bg-white/20 dark:bg-white/2 backdrop-blur-2xl relative z-10">
          <div className="flex items-center gap-4 lg:gap-6">
            <Avatar className="h-12 w-12 lg:h-16 lg:w-16 border-2 lg:border-4 border-white dark:border-slate-800 shadow-xl group-hover:scale-110 transition-transform duration-700">
            ...
            <div className="flex flex-col">
              <span className="text-base lg:text-xl font-black text-slate-900 dark:text-white tracking-tight">
                {testimonial.authorName}
              </span>
              <span className="text-[10px] lg:text-xs font-black uppercase tracking-[0.2em] text-slate-400">
